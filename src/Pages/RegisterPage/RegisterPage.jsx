    ...
    const handleSubmit = async (e) =>  {
        ...
        try {
            ...
            set(ref(db, `users/${user.uid}`), {
                email: email, username: username, totalScore: totalScore, bio:bio, city:city, socialMediaUrl
              });
          } catch (err) {
            console.error(err);
            alert(err.message);
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group text-left">
                  ...
                  <div className="form-group text-left">
                    ...
                    <input type="number" onChange={e => setTotalScore(e.target.value)}
                        className="form-control" 
                        id="totalscore" 
                        placeholder="0"
                    />
                  ...
                  <div className="form-group text-left">
                    ...
                    <input type="text" onChange={e => setSocialMediaUrl(e.target.value)}
                        className="form-control" 
                        id="socialmediaurl" 
